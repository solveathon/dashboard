        ...
        columnDefs: [{
            ...
            render: function(e, a, s, t) {
                var r = s.logo
                  ...
                  , n = s.user
                  , i = s.image;
                return s = i ? '<img src="' + assetsPath + "img/avatars/" + i + '" alt="Avatar" class="rounded-circle">' : '<span class="avatar-initial rounded-circle bg-label-' + ["success", "danger", "warning", "info", "dark", "primary", "secondary"][Math.floor(6 * Math.random())] + '">' + (i = (((i = s.user.match(/\b\w/g) || []).shift() || "") + (i.pop() || "")).toUpperCase()) + "</span>",
                '<div class="d-flex align-items-center"><span class="me-3">' + l[r] + '</span><div><a class="text-heading text-truncate fw-medium mb-2 text-wrap" href="app-academy-course-details.html">' + o + '</a><div class="d-flex align-items-center mt-1"><div class="avatar-wrapper me-2"><div class="avatar avatar-xs">' + s + '</div></div><span class="text-nowrap">' + n + "</span></div></div></div>"
            }
        }, {
            targets: 3,

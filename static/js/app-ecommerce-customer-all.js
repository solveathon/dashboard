...
$(function() {
        ...
        o.length && (o = o).wrap('<div class="position-relative"></div>').select2({
            ...
            ajax: assetsPath + "json/dataFinal.json",
            columns: [{
                data: ""
            }, {
                data: "id"
            ...
            columnDefs: [{
                ...
                render: function(e, t, s, a) {
                    var n = s.team_name,
                        o = s.team_leader,
                        r = s.image;
                    return '<div class="d-flex justify-content-start align-items-center customer-name"><div class="avatar-wrapper"><div class="avatar me-2">' + (r ? '<img src="' + assetsPath + "img/avatars/" + r + '" alt="Avatar" class="rounded-circle">' : '<span class="avatar-initial rounded-circle bg-label-' + ["success", "danger", "warning", "info", "dark", "primary", "secondary"][Math.floor(6 * Math.random())] + '">' + (r = (((r = (n = s.team_name).match(/\b\w/g) || []).shift() || "") + (r.pop() || "")).toUpperCase()) + "</span>") + '</div></div><div class="d-flex flex-column"><a href="/team?teamID=' + s.id + '" ><span class="fw-medium">' + n + '</span></a><small class="text-muted">' + o + "</small></div></div>"
                }
            }, {
                targets: 3,
                render: function(e, t, s, a) {
                    return "<span class='fw-medium text-heading'>" + s.table_no + "</span>"
                }
            }, {
                targets: 4,
                render: function(e, t, s, a) {
                    var n = s.campus;
                    return '<div class="d-flex justify-content-start align-items-center customer-country"><div><span>' + n.toUpperCase() + '</span></div></div>';
                }
            }, {
                targets: 5,
                render: function(e, t, s, a) {
                    var n = s.status;
                    if (n == "Pending") return `<span class="badge bg-label-danger">` + n + `</span>`
                    else return `<span class="badge bg-label-success">` + n + `</span>`
                    
                }
            }, {
                targets: 6,
                render: function(e, t, s, a) {
                    return '<span class="fw-medium text-heading">' + s.total_points + "</span>"
                }
            }],
            order: [
                [2, "desc"]
            ...
            responsive: {
                details: {
                    display: $.fn.dataTable.Responsive.display.modal({
                        header: function(e) {
                            return "Details of " + e.data().team_name
                        }
                    }),
                    type: "column",
